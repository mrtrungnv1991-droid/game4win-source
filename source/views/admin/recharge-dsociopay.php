...
$listDatatable = $CMSNT->get_list(" SELECT * FROM `payment_dsociopay` WHERE $where ORDER BY `id` DESC LIMIT $from,$limit ");
$totalDatatable = $CMSNT->num_rows(" SELECT * FROM `payment_dsociopay` WHERE $where ORDER BY id DESC ");
...
$total_yesterday = intval($CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 AND  `created_at` LIKE '%" . $yesterday . "%' ")['SUM(price)']);
$total_today = $CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 AND `created_at` LIKE '%" . $currentDate . "%' ")['SUM(price)'];
$total_all_time = $CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 ")['SUM(price)'];

require_once(__DIR__ . '/../../libs/dsociopay.php');

$checkKey = checkAddonLicense($CMSNT->site('dsociopay_license'), 'SHOPCLONE7_GATEWAY_DSOCIOPAY');
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control" name="dsociopay_status">
                                                    <option <?= $CMSNT->site('dsociopay_status') == 1 ? 'selected' : ''; ?> value="1">ON</option>
                                                    <option <?= $CMSNT->site('dsociopay_status') == 0 ? 'selected' : ''; ?> value="0">OFF</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" placeholder="921abf4dbff01xxxxxf3c562c356c769" value="<?= $CMSNT->site('dsociopay_license'); ?>" name="dsociopay_license">
                                            </div>
                                            <div style="margin-top: 10px; padding: 10px; background-color: #fff3cd; border: 1px solid #ffeeba; border-radius: 4px; color: #856404;">
                                                <strong>Chú ý:</strong> Bạn cần phải mua giấy phép kích hoạt <a target="_blank" style="color: #007bff;" href="https://client.cmsnt.co/cart.php?a=add&pid=109">Addon</a> trước khi sử dụng.
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="col-lg-12 col-xl-6">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $CMSNT->site('dsociopay_name') ?: 'DSocioPay'; ?>" name="dsociopay_name" placeholder="DSocioPay">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center mb-2">
                                                    <?php if ($CMSNT->site('dsociopay_icon')): ?>
                                                        <img src="<?= base_url($CMSNT->site('dsociopay_icon')); ?>" width="40" height="40" class="me-2 rounded" style="object-fit: contain;">
                                                    <?php endif; ?>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $CMSNT->site('dsociopay_currency_code'); ?>" name="dsociopay_currency_code">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-sm-5 col-form-label"><?= __('1 ' . $CMSNT->site('dsociopay_currency_code') . ' ='); ?></label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?= $CMSNT->site('dsociopay_rate'); ?>" name="dsociopay_rate">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" value="<?= $CMSNT->site('dsociopay_private_key'); ?>" name="dsociopay_private_key">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?= $CMSNT->site('dsociopay_webhook_secret'); ?>" name="dsociopay_webhook_secret" id="webhook-secret" placeholder="Nhập mật khẩu bảo vệ webhook">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?= base_url('api/webhook_dsociopay.php' . (!empty($CMSNT->site('dsociopay_webhook_secret')) ? '?secret=' . $CMSNT->site('dsociopay_webhook_secret') : '')); ?>" readonly>
                                                    <button type="button" class="btn btn-outline-primary copy" data-clipboard-text="<?= base_url('api/webhook_dsociopay.php' . (!empty($CMSNT->site('dsociopay_webhook_secret')) ? '?secret=' . $CMSNT->site('dsociopay_webhook_secret') : '')); ?>" onclick="copy()">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-7">
                                                <textarea class="form-control" rows="4" placeholder="100|5 (tức nạp 100 <?= $CMSNT->site('dsociopay_currency_code') ?: 'NGN'; ?> khuyến mãi 5%)
200|10 (tức nạp 200 <?= $CMSNT->site('dsociopay_currency_code') ?: 'NGN'; ?> khuyến mãi 10%)" name="dsociopay_promotions"><?= $CMSNT->site('dsociopay_promotions'); ?></textarea>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="dsociopay_notice" name="dsociopay_notice"><?= $CMSNT->site('dsociopay_notice'); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif ?>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 AND MONTH(created_at) = '$currentMonth' AND YEAR(created_at) = '$currentYear' ")['SUM(price)']); ?>
                                        </p>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-fill">
                                        <p class="mb-1 fs-5 fw-semibold text-default">
                                            <?= format_currency($CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 AND YEAR(created_at) = $currentYear AND WEEK(created_at, 1) = $currentWeek ")['SUM(price)']); ?>
                                        </p>
                                ...
                                const data = {
                                    ...
                                    datasets: [{
                                        ...
                                        data: [
                                            ...
                                            for ($day = 1; $day <= $numOfDays; $day++) {
                                                $date = "$year-$month-$day";
                                                $row = $CMSNT->get_row("SELECT SUM(price) FROM payment_dsociopay WHERE `status` = 1 AND DATE(created_at) = '$date' ");
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="float-right">
                                                <?= __('Paid:'); ?> <strong style="color:red;"><?= format_currency($CMSNT->get_row(" SELECT SUM(`price`) FROM `payment_dsociopay` WHERE $where AND `status` = 1 ")['SUM(`price`)']); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                </tfoot>
