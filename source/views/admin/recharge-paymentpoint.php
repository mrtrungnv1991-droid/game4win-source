                                ...
                                <?php else: ?>
                                    <div class="col-lg-12 col-xl-6">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" value="<?= $CMSNT->site('paymentpoint_name') ?: 'PaymentPoint'; ?>" name="paymentpoint_name" placeholder="PaymentPoint">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="d-flex align-items-center mb-2">
                                                    <?php if ($CMSNT->site('paymentpoint_icon')): ?>
                                                        <img src="<?= base_url($CMSNT->site('paymentpoint_icon')); ?>" width="40" height="40" class="me-2 rounded" style="object-fit: contain;">
                                                    <?php endif; ?>
