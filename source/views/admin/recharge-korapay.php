                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" rows="4" placeholder="100|5 (<?=sprintf(__('tức nạp %s %s khuyến mãi %s%%'), '100', $CMSNT->site('korapay_currency_code'), '5');?>)
200|10 (<?=sprintf(__('tức nạp %s %s khuyến mãi %s%%'), '200', $CMSNT->site('korapay_currency_code'), '10');?>)
" name="korapay_promotions"><?=$CMSNT->site('korapay_promotions');?></textarea>
